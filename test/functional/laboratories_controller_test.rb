...
class LaboratoriesControllerTest < ActionController::TestCase
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post :create, laboratory: { email: @laboratory.email, municipality_id: @laboratory.municipality_id, name: @laboratory.name, phone: @laboratory.phone, uid: @laboratory.uid }
    end
  ...
  test "should update laboratory" do
    put :update, id: @laboratory, laboratory: { email: @laboratory.email, municipality_id: @laboratory.municipality_id, name: @laboratory.name, phone: @laboratory.phone, uid: @laboratory.uid }
    assert_redirected_to laboratory_path(assigns(:laboratory))
  end
